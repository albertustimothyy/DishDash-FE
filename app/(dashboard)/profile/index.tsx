...
export default function Profile() {
  return (
    <View className="flex items-center justify-center bg-white">
      <SafeAreaView />
      <View className="top-0 items-center justify-center w-full h-64 bg-white shadow-sm rounded-3xl shadow-gray-400">
        <Image
          className="content-center w-40 h-40 rounded-full"
          source={require("../../../assets/profile.jpg")}
        />
        <Text className="text-2xl font-bold ">John Doe</Text>
        <View className="flex flex-row items-center justify-between w-4/5 mt-2">
